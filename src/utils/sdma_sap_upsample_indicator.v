...
//----------------------------------OUTPUT LOGIC--------------------------------
assign	o_sap_ui_upsampleflag = i_sap_ui_upsampleen && ~i_sap_ui_paddingflag && ~((i_sap_ui_upsamplexcnt == {(`SDMA_INST_INSERTZERONUMWIDTH){1'b0}}) && (i_sap_ui_upsampleycnt == {(`SDMA_INST_INSERTZERONUMWIDTH){1'b0}}));
//------------------------------------------------------------------------------
