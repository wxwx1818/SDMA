...
sdma_sport_mux U_SDMA_SPORT_MUX_0(
  ...
  .o_sdma_ahbraddr                      (o_sdma_ahbraddr[`SDMA_ADDRWIDTH-1:0]),
  .o_sdma_ahbren                        (o_sdma_ahbren[`SDMA_AHBDATAWIDTH/8-1:0]),
...
sdma_dport_mux U_SDMA_DPORT_MUX_0(
  ...
  .o_sdma_ahbwen     					(o_sdma_ahbwen[`SDMA_AHBDATAWIDTH/8-1:0]),
  .o_sdma_ahbwaddr   					(o_sdma_ahbwaddr[`SDMA_ADDRWIDTH-1:0]),
